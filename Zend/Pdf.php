...
/** Zend_Pdf_Page */
require_once 'Pdf/Page.php';

/** Zend_Pdf_Style */
require_once 'Pdf/Style.php';

/** Zend_Pdf_Color_GrayScale */
require_once 'Pdf/Color/GrayScale.php';

/** Zend_Pdf_Color_Rgb */
require_once 'Pdf/Color/Rgb.php';

/** Zend_Pdf_Color_Cmyk */
require_once 'Pdf/Color/Cmyk.php';

/** Zend_Pdf_Color_Html */
require_once 'Pdf/Color/Html.php';

/** Zend_Pdf_Image */
require_once 'Pdf/Image.php';

/** Zend_Pdf_Font */
require_once 'Pdf/Font.php';

/** Zend_Pdf_Resource_Extractor */
require_once 'Pdf/Resource/Extractor.php';

/** Zend_Pdf_Canvas */
require_once 'Pdf/Canvas.php';


/** Internally used classes */
require_once 'Pdf/Element.php';
require_once 'Pdf/Element/Array.php';
require_once 'Pdf/Element/String/Binary.php';
require_once 'Pdf/Element/Boolean.php';
require_once 'Pdf/Element/Dictionary.php';
require_once 'Pdf/Element/Name.php';
require_once 'Pdf/Element/Null.php';
require_once 'Pdf/Element/Numeric.php';
require_once 'Pdf/Element/String.php';
...
class Zend_Pdf
{
  /**** Class Constants ****/
    ...
    {
        require_once 'Pdf/ElementFactory.php';
        ...
        if ($source !== null) {
            ...
            require_once 'Pdf/Trailer/Generator.php';
    ...
    protected function _loadNamedDestinations(Zend_Pdf_Element_Reference $root, $pdfHeaderVersion)
    {
        ...
        if ($versionIs_1_2_plus) {
            ...
            if ($root->Names !== null  &&  $root->Names->Dests !== null) {
                require_once 'Pdf/NameTree.php';
                require_once 'Pdf/Target.php';
    ...
    protected function _loadOutlines(Zend_Pdf_Element_Reference $root)
    {
        ...
        while ($outlineDictionary !== null  &&  !$processedDictionaries->contains($outlineDictionary)) {
            ...
            require_once 'Pdf/Outline/Loaded.php';
    ...
    protected function _dumpPages()
    {
        ...
        // Refresh outlines
        require_once 'Pdf/RecursivelyIteratableObjectsContainer.php';
    ...
    public function extractFonts()
    {
        ...
        foreach ($fontResourcesUnique as $resourceId => $fontDictionary) {
            try {
                // Try to extract font
                require_once 'Pdf/Resource/Font/Extracted.php';
