...
require_once 'Element/Array.php';
require_once 'Element/String/Binary.php';
require_once 'Element/Boolean.php';
require_once 'Element/Dictionary.php';
require_once 'Element/Name.php';
require_once 'Element/Null.php';
require_once 'Element/Numeric.php';
require_once 'Element/String.php';
require_once 'Resource/Unified.php';

require_once 'Canvas/Abstract.php';
  ...
  /* Line Dash Types */
    ...
    public function extractFonts()
    {
        ...
        foreach ($fontResourcesUnique as $resourceId => $fontDictionary) {
            try {
                require_once 'Resource/Font/Extracted.php';
                // Try to extract font
